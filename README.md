...
function updateTable(){
  ...
  total1P.textContent = `${roommates[0].username}: ₹${total[roommates[0].username]}`;
  total2P.textContent = `${roommates[1].username}: ₹${total[roommates[1].username]}`;
  totalAllP.textContent = `Total: ₹${total[roommates[0].username]+total[roommates[1].username]}`;
}
</script>
</body>
</html>
